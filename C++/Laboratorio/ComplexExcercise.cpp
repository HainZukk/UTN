...
int main (){
    ...
    cout << "Ingrese el importe de la semana 1: ";
    cin >> semana1;

    cout << "Ingrese el importe de la semana 2: ";
    cin >> semana2;

    cout << "Ingrese el importe de la semana 3: ";
    cin >> semana3;

    cout << "Ingrese el importe de la semana 4: ";
    cin >> semana4;
